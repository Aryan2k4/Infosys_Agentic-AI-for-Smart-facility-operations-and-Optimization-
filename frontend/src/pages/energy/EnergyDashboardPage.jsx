...
export default function EnergyDashboardPage() {
  ...
  return (
    <div className="min-h-screen animate-fade-in relative overflow-hidden">
      ...
      <div className="relative border-b border-slate-200 dark:border-slate-800/80 px-6 md:px-10 py-6 flex items-end justify-between flex-wrap gap-4">
        <div>
          <div className="mb-2">
            <LiveIndicator lastUpdated={lastUpdated} isRefreshing={refreshing} onRefresh={refreshNow} />
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-bold text-ink dark:text-slate-100 tracking-tight">
            Energy Monitoring
          </h1>
      ...
      <div className="relative p-6 md:p-10 flex flex-col gap-6 max-w-[1400px]">
        {/* Bento row 1 — hero stat + main chart, asymmetric */}
        ...
        {/* Bento row 2 — supporting KPIs */}
        <div className={`grid grid-cols-1 sm:grid-cols-3 gap-4 transition-opacity ${rangeLoading ? 'opacity-50' : ''}`}>
        ...
        <div className="rounded-2xl border border-teal-500/20 dark:border-teal-400/15 bg-teal-500/[0.03] dark:bg-teal-400/[0.03] p-4 md:p-6">
